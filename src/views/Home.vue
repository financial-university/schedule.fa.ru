<template>
  <div class="container">
    <div class="row">
        ...
        <a href="tg://resolve?domain=FinancialUniversityBot" class="block">
          <h3>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 240 240">
              <defs><linearGradient id="a" x1=".667" x2=".417" y1=".167" y2=".75">
                <stop offset="0" stop-color="#37aee2"/><stop offset="1" stop-color="#1e96c8"/></linearGradient>
                <linearGradient id="b" x1=".66" x2=".851" y1=".437" y2=".802"><stop offset="0" stop-color="#eff7fc"/><stop offset="1" stop-color="#fff"/></linearGradient></defs>
              <circle cx="120" cy="120" r="120" fill="url(#a)"/><path fill="#c8daea" d="M98 175c-3.888 0-3.227-1.468-4.568-5.17L82 132.207 170 80"/>
      ...
      <div class="item">
        <router-link v-bind:to="'/calendar'">
          <h3>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 240 240">
              <defs><linearGradient id="a" x1=".667" x2=".417" y1=".167" y2=".75">
                <stop offset="0" stop-color="#37aee2"/><stop offset="1" stop-color="#1e96c8"/></linearGradient>
